...
<body>
	...
	<form id="studentForm" name="studentForm" action="<%=request.getContextPath()%>/studentAdd" method="post" >
		<table>
			<tr>
				<td>学号</td>
				<td>
		...
		<input type="button" onclick="window.location='<%=request.getContextPath()%>/jsp/index.jsp'" value="返回">
	</form>
